 ...
 *
 * <p>To use <code>SherlockActionBarToggle</code>, create one in your Activity and call through
 ...
 * has occurred.</p>
 *
 * <p><code>SherlockActionBarToggle</code> can be used directly as a
 ...
 */
public class SherlockActionBarToggle implements DrawerListener, PanelSlideListener {
    ...
    private static class ActionBarDrawerToggleImplCompat implements ActionBarDrawerToggleImpl {
        ...
        public Drawable getThemeUpIndicator(Activity activity) {
        	return SherlockActionBarToggleCompat.getThemeUpIndicator(activity);
        }

        @Override
        public Object setActionBarUpIndicator(Object info, Activity activity,
                Drawable themeImage, int contentDescRes) {
        	return SherlockActionBarToggleCompat.setActionBarUpIndicator(info, activity,
                    themeImage, contentDescRes);
        }

        @Override
        public Object setActionBarDescription(Object info, Activity activity, int contentDescRes) {
        	return SherlockActionBarToggleCompat.setActionBarDescription(info, activity,
                    contentDescRes);
        }
    }
    ...
    private static class ActionBarDrawerToggleImplHC implements ActionBarDrawerToggleImpl {
        @Override
        public Drawable getThemeUpIndicator(Activity activity) {
            return SherlockActionBarToggleHoneycomb.getThemeUpIndicator(activity);
        }

        @Override
        public Object setActionBarUpIndicator(Object info, Activity activity,
                Drawable themeImage, int contentDescRes) {
            return SherlockActionBarToggleHoneycomb.setActionBarUpIndicator(info, activity,
                    themeImage, contentDescRes);
        }

        @Override
        public Object setActionBarDescription(Object info, Activity activity, int contentDescRes) {
            return SherlockActionBarToggleHoneycomb.setActionBarDescription(info, activity,
                    contentDescRes);
        }
    }
    ...
    /**
     * Construct a new SherlockActionBarToggle.
     *
     ...
     *                                  for accessibility
     */
    public SherlockActionBarToggle(Activity activity, ViewGroup layout,
     ...
     * may have diverged in such a way that the SherlockActionBarToggle was not notified.
     ...
     * SherlockActionBarToggle instance directly as your SlidingPaneLayout's listener, you should call
     ...
     * SherlockActionBarToggle instance directly as your DrawerLayout's listener, you should call
     * through to this method from your own listener object.
     *
