package com.actionbarsherlock.plus.view;
...
public class Gallery extends AbsSpinner implements GestureDetector.OnGestureListener {
    ...
    public Gallery(Context context, AttributeSet attrs, int defStyle) {
        ...
        int index = a.getInt(R.styleable.Gallery_gravityNew, -1);
        if (index >= 0) {
            setGravity(index);
        }

        int animationDuration =
                a.getInt(R.styleable.Gallery_animationDuration, mAnimationDuration);
        ...
        float unselectedAlpha = a.getFloat(
                R.styleable.Gallery_unselectedAlphaNew, 0.5f);
