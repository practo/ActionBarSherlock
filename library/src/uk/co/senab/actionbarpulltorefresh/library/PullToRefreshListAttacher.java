...
public final class PullToRefreshListAttacher implements View.OnTouchListener {
     ...
     */
    private static final int DEFAULT_HEADER_LAYOUT = R.layout.ptr_default_list_header;
    private static final int DEFAULT_FOOTER_LAYOUT = R.layout.ptr_default_list_footer;
